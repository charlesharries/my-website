...
# Use ruby whatever
ruby '2.3.4'
# Use postgres for all the databases
gem 'pg'
...
gem 'simple_form', '~> 3.2'
# Use Redcarpet to convert markdown into HTML for posts
gem 'redcarpet'
# Use CarrierWave for image upload
gem 'carrierwave', github: 'carrierwaveuploader/carrierwave' # So we have access to mount_uploaders
